...
orig_ip, levels, crash_treshold = eval(name)
player_x_env = orig_ip[0]
player_y_env = orig_ip[1]
...
def onclick(event):
    ...
    print(text_str)
    print ('-'*50)
    text = ax.text(25,275, text_str, style='italic', bbox={'facecolor': 'white', 'alpha': 0.5})
    plt.axis('off')
    plt.show()
